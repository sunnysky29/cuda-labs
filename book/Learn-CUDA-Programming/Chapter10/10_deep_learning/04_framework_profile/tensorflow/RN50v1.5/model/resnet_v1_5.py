...
class ResnetModel(object):
    ...
    def build_model(self, inputs, training=True, reuse=False):
        ...
        with var_storage.model_variable_scope(
            ...
            # NVTX annotation - conv1
            inputs, nvtx_context = nvtx_tf.ops.start(inputs, message='conv1', \
                domain_name='Forward', grad_domain_name='Gradient', enabled=True, trainable=True)
            ...
            net = nvtx_tf.ops.end(net, nvtx_context) # NVTX: conv1

            # NVTX annotation - conv2
            net, nvtx_context = nvtx_tf.ops.start(net, message='conv2', \
                domain_name='Forward', grad_domain_name='Gradient', enabled=True, trainable=True)
            ...
            net = nvtx_tf.ops.end(net, nvtx_context) # NVTX: conv2

            # NVTX annotation - conv3
            net, nvtx_context = nvtx_tf.ops.start(net, message='conv3', \
                domain_name='Forward', grad_domain_name='Gradient', enabled=True, trainable=True)
            ...
            net = nvtx_tf.ops.end(net, nvtx_context) # NVTX: conv3

            # NVTX annotation - conv4 
            net, nvtx_context = nvtx_tf.ops.start(net, message='conv4', \
                domain_name='Forward', grad_domain_name='Gradient', enabled=True, trainable=True)
            ...
            net = nvtx_tf.ops.end(net, nvtx_context) # NVTX: conv4

            # NVTX annotation - conv5
            net, nvtx_context = nvtx_tf.ops.start(net, message='conv5', \
                domain_name='Forward', grad_domain_name='Gradient', enabled=True, trainable=True)
            ...
            net = nvtx_tf.ops.end(net, nvtx_context) # NVTX: conv5

            # NVTX annotation - fc
            net, nvtx_context = nvtx_tf.ops.start(net, message='fc', 
                domain_name='Forward', grad_domain_name='Gradient', enabled=True, trainable=True)
            ...
            logits = nvtx_tf.ops.end(net, nvtx_context) # NVTX: fc
